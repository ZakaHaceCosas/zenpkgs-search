<script lang="ts">
    ...
    const modals = $state<Record<(typeof VisibleType)[keyof typeof VisibleType], boolean>>({
        [VisibleType.MAbout]: false,
        [VisibleType.MSettings]: false,
        [VisibleType.PMenu]: false
    });
    ...
    const toggleVisible = (id: keyof typeof VisibleType) => {
        modals[VisibleType[id]] = !modals[VisibleType[id]];
    };
</script>
...
<div
    id="menu-popover"
    class={"popover-inner common-popover " + (modals[VisibleType.PMenu] === true ? "visible" : "")}
>
    <div
        class="menu-item"
        onclick={() => {
    ...
    <div class="menu-item">
        Developer News <span id="menu-news-badge" style="color:var(--accent-red); margin-left:4px;"
            >●</span
        >
    </div>
    <div class="menu-item">
...
<!-- SETTINGS MODAL -->
<div
    class={"overlay-backdrop " + (modals[VisibleType.MSettings] === true ? "visible" : "")}
    id="modal-settings"
>
...
<div class="overlay-backdrop" id="modal-about">
    <div class="adw-window" id="about-window" style="max-width: 400px; text-align: center;">
        <div class="dialog-header">
            <button class="adw-button icon-only" id="about-back-btn" style="visibility: hidden;">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height="16px"
                    viewBox="0 0 16 16"
